...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		alignment			: 'bottomLeft', //topLeft, topCenter, topRight, centerLeft, center, centerRight, bottomLeft, bottomCenter, bottomRight		
		...
		height				: '34.71%',	//here you can type pixels (for instance '300px'), a percentage (relative to the width of the slideshow, for instance '50%') or 'auto'		
		...
		rows				: 4,		
		slicedCols			: 4,	//if 0 the same value of cols		
